...
public static partial class BabblerConfig
{
    ...
    private static void InitializeIncidentals(ConfigFile config)
    {
        ...
        Utilities.EnforceMinMax(ref IncidentalsMinTVChance, ref IncidentalsMaxTVChance);
    }
    ...
    private static void ResetIncidentals()
    {
        ...
        IncidentalsMinTVChance.Value = (float)IncidentalsMinTVChance.DefaultValue;
        IncidentalsMaxTVChance.Value = (float)IncidentalsMaxTVChance.DefaultValue;
    }
}